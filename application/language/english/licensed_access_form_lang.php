...
$lang['filled_lead_research']='<p>This form must be filled and submitted by the Lead Researcher. Lead Researcher refers to 
...
which access to the data is requested. The Lead Researcher assumes all responsibility for compliance with all 
terms of this Data Access Agreement by employees of the receiving organization.</p>

<p>This request will be reviewed by a data release committee, 
who may decide to approve the request, to deny access to the data, 
or to request additional information from the Lead Researcher. A signed copy of this request form may also be requested. </p>

<p>This request is submitted on behalf of:</p>';
...
$lang['agreement_text']='<p>The representative of the Receiving Organization agrees to comply with the following conditions:</p>
<ol>
<li>Access to the restricted data will be limited to the Lead Researcher and other members of the research team listed in this request.</li>
<li>Copies of the restricted data or any data created on the basis of the original data will not be copied or made available to anyone other than those mentioned in this Data Access Agreement, unless formally authorized by the Data Archive.</li>
...
<li>Any books, articles, conference papers, theses, dissertations, reports, or other publications that employ data obtained from the Data Archive will cite the source of data in accordance with the citation requirement provided with the dataset.</li>
<li>An electronic copy of all reports and publications based on the requested data will be sent to the Data Archive.</li>
<li>The original collector of the data, the Data Archive, and the relevant funding agencies bear no responsibility for use of the data or for interpretations or inferences based upon such uses.</li>
<li>This agreement will come into force on the date that approval is given for access to the restricted dataset and remain in force until the completion date of the project or an earlier date if the project is completed ahead of time.</li>

<li>If there are any changes to the project specification, security arrangements, personnel or organization detailed in this application form, it is the responsibility of the Lead Researcher to seek the agreement of the Data Archive to these changes. Where there is a change to the employer organization of the Lead Researcher this will involve a new application being made and termination of the original project.</li>
<li>Breaches of the agreement will be taken seriously and the Data Archive will take action against those responsible for the lapse if willful or accidental. Failure to comply with the directions of the Data Archive will be deemed to be a major breach of the agreement and may involve recourse to legal proceedings. The Data Archive will maintain and share with partner data archives a register of those individuals and organizations which are responsible for breaching the terms of the Data Access Agreement and will impose sanctions on release of future data to these parties. </li>
</ol>';
