...
class Cache
{
	...
	private $cache_disabled;// if set to 1, disable caching
	...
	function __construct()
	{
		...
		if (!is_numeric($this->default_expires) || !$this->default_expires>0)
		{
			$this->default_expires=200; //default expire
		}
