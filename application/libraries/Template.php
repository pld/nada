...
class CI_Template {
   ...
   /**
	 * Add variables to be passed to template output
	 *
	 * @access	public
   ...
   function render($region = NULL, $buffer = FALSE, $parse = FALSE)
   {
      ...
      else
      {
		 ...
		 //add global variables to final output
		 foreach($this->globals as $name=>$content)
		 {
