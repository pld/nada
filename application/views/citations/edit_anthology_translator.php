...
<div class="field">
    <label for="alt_title"><?php echo t('editor_work_title');?></label>
    <input name="alt_title" type="text" id="alt_title" size="50" class="input-flex"  value="<?php echo get_form_value('alt_title',isset($alt_title) ? $alt_title: ''); ?>"/>
</div>

<?php echo form_author_field("author",'Author(s)'); ?>
<?php echo form_author_field("translator",'Translator(s)'); ?>
<?php echo form_author_field("editor",'Editor(s)'); ?>
...
<table border="0" class="inline-fields">
    ...
    <div class="field">
        ...
        <input name="page_to" type="text" id="page_to" size="10" maxlength="10" class="input-flex" value="<?php echo get_form_value('page_to',isset($page_to) ? $page_to: ''); ?>"/>
    </div>
    </td>
