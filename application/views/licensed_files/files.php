...
<div class="page-links">
	<a href="<?php echo current_url(); ?>/add" class="button"><img src="images/icon_plus.gif"/>Add new file</a> 
</div>
...
<h1 class="page-title"><?php echo t('Licensed survey files');?></h1>
...
<form autocomplete="off">
    ...
    <table class="grid-table" width="100%" cellspacing="0" cellpadding="0">
    	<tr class="header">
            ...
            <th><?php echo create_sort_link($sort_by,$sort_order,'file_name',t('Filename'),$page_url); ?></th>
            <th><?php echo create_sort_link($sort_by,$sort_order,'file_path',t('Path'),$page_url); ?></th>
            <th>Size</th>
	...
	<?php foreach($rows as $row): ?>
    	...
    	<tr class="<?php echo $tr_class; ?>">
            ...
            <td><a href="<?php echo current_url();?>/edit/<?php echo $row->id;?>""><?php echo $row->file_name; ?></a></td>
            <td><?php echo $row->file_path; ?></td>
            <td><?php echo round(filesize($row->file_path)/1024/1024,2);?> MB</td>
			<td>
            	<a href="<?php echo current_url();?>/edit/<?php echo $row->id;?>">Edit</a> | 
                <a href="<?php echo current_url();?>/delete/<?php echo $row->id;?>">Delete</a>
            </td>
        </tr>
    <?php endforeach;?>
    </table>
